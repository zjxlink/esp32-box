...
typedef struct
{
	...
	lv_obj_t *screen_wifi_ta_pwd;
	lv_obj_t *screen_wifi_ddlist_ssid;
	lv_obj_t *screen_wifi_btn_connect;
	lv_obj_t *screen_wifi_btn_connect_label;
	lv_obj_t *screen_wifi_btn_rescan;
	lv_obj_t *screen_wifi_btn_rescan_label;
	lv_obj_t *screen_sleep;
	bool screen_sleep_del;
	lv_obj_t *g_kb_screen_sleep;
	...
	lv_obj_t *screen_main_ta_question;
	lv_obj_t *screen_main_ta_answer;
	lv_obj_t *screen_listen;
	bool screen_listen_del;
	lv_obj_t *g_kb_screen_listen;
	lv_obj_t *screen_listen_label_1;
}lv_ui;
...
LV_FONT_DECLARE(lv_font_pingfang_36)
LV_FONT_DECLARE(lv_font_montserratMedium_16)
LV_FONT_DECLARE(lv_font_pingfang_16)

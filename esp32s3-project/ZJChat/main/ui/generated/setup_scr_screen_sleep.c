...
void setup_scr_screen_sleep(lv_ui *ui)
{
	...
	ui->g_kb_screen_sleep = lv_keyboard_create(ui->screen_sleep);
	lv_obj_add_event_cb(ui->g_kb_screen_sleep, kb_event_cb, LV_EVENT_ALL, NULL);
	lv_obj_add_flag(ui->g_kb_screen_sleep, LV_OBJ_FLAG_HIDDEN);
	lv_obj_set_style_text_font(ui->g_kb_screen_sleep, &lv_font_SourceHanSerifSC_Regular_12, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_size(ui->screen_sleep, 320, 240);
	...
	lv_label_set_text(ui->screen_sleep_label_1, "\n请说\n“hi! ESP” \n唤醒我");
	lv_label_set_long_mode(ui->screen_sleep_label_1, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->screen_sleep_label_1, 7, 5);
	lv_obj_set_size(ui->screen_sleep_label_1, 307, 231);
	...
	lv_obj_set_style_text_font(ui->screen_sleep_label_1, &lv_font_pingfang_36, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_opa(ui->screen_sleep_label_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_letter_space(ui->screen_sleep_label_1, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_bg_opa(ui->screen_sleep_label_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_sleep_label_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->screen_sleep_label_1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_top(ui->screen_sleep_label_1, 8, LV_PART_MAIN|LV_STATE_DEFAULT);
